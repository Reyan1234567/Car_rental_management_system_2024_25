...
registrationForm.addEventListener('submit', function (event) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 6, , 7]);
                return [4 /*yield*/, fetch('http://localhost:3333/auth/register', {
                        method: 'POST',
                        headers: {
            ...
            case 2:
                response = _a.sent();
                if (!(response.ok || response.status === 201)) return [3 /*break*/, 3];
            ...
            case 4:
                error = _a.sent();
                alert("Registration failed: ".concat(error.message));
                _a.label = 5;
